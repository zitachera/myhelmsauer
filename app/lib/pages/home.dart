...
class _HomePageState extends State<HomePage> {
  ...
  /// ➜ INCHANGÉ : gestion du tap
  void _onItemTapped(int index) {
    setState(() => _selectedIndex = index);
  }

  /// ➜ INCHANGÉ : reload global
  Future _reload() async {
    await widget.reloadData();
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    /// ==========================================================
    /// 🔹 BOTTOM NAV BAR – DESIGN AMÉLIORÉ (LOGIQUE IDENTIQUE)
    /// ==========================================================
    final bottomNavigationBar = Container(
      // ✅ AJOUT : Ombre douce pour effet "floating"
      decoration: BoxDecoration(
        color: Colors.white,
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.08), // ombre subtile
            blurRadius: 12,
      ...
      child: BottomNavigationBar(
        ...
        // ✅ AJOUT : tailles de texte plus modernes
        selectedFontSize: 12,
        ...
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            icon: SvgIcon(
              "images/menu/schaden.svg",
              color: Colors.red, // ➜ déjà présent, gardé
            ),
            label: 'Schaden',
          ),
          BottomNavigationBarItem(
        ...
        // ✅ LÉGÈRE AMÉLIORATION : couleurs plus douces
        selectedItemColor: helmsauerBlau,
